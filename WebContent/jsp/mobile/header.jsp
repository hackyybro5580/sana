...
<div class="container" style="width: 100%;z-index: 999;position: sticky;top :0;background: white;">
    <div class="row">
      	<div class="alignCenter">
			<table style="width: 100%;">
				<tr>
					<td style="text-align: center;padding: 0;width: 100px">
						<a href="/homepage" style="float: right;margin-top: -96px;"><i class="fa fa-bars" style="font-size: 67px;"></i></a>
					</td>
				                ...
				                <div>
				                    <div class="header-top-right">
				                        <div class="order-cart">
				                            <ul>
				                                <li class="cart" id="shoppingCart" style="border: 0;"><a href="/cart"><i class="fa fa-shopping-cart" style="font-size: 67px;"></i><p id="cartLength"><%=cart.length()%></p></a>
				                                      <%if(cart.length()>0){%>
